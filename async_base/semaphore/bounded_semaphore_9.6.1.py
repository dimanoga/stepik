...
async def fetch_apartment_data(min_price: int, max_price: int, rooms: int, apartment: dict):
...
async def main():
    ...
    await asyncio.gather(
        *[fetch_apartment_data(min_price, max_price, rooms, apartment) for apartment in apartments_data])
