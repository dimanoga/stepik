...
async def log_to_file(player_name, message, delay):
    async with aiofiles.open('file.txt', mode='a', encoding='utf-8') as f:
        await asyncio.sleep(delay)
        await f.write(f"{delay:.2f}: {player_name}: {message}\n")


async def main():
    await asyncio.gather(*[log_to_file(player_name, message, delay) for player_name, message, delay in input_data])
